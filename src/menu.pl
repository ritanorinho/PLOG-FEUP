...
/*COMPUTADOR VS COMPUTADOR NIVEL 1*/
start_game(4):-
                initialBoard(Board),
                display_board(Board),
                loop_game(Board,1,NextPlayer,'y',1,2,1).

/*COMPUTADOR VS COMPUTADOR NIVEL 2*/
start_game(5):-
                initialBoard(Board),
                display_board(Board),
                loop_game(Board,1,NextPlayer,'y',1,2,2).

main_menu:- write('1- JOGADOR VS JOGADOR'),nl,
            write('2- JOGADOR VS COMPUTADOR NIVEL 1'),nl,
            write('3- JOGADOR VS COMPUTADOR NIVEL 2'),nl,
            write('4- COMPUTADOR VS COMPUTADOR NIVEL 1'),nl,
            write('5- COMPUTADOR VS COMPUTADOR NIVEL 2'),nl,
